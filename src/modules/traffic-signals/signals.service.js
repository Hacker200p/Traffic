...
class SignalsService {
    async create(input) {
        ...
        const result = await connection_1.db.query(`INSERT INTO traffic_signals (id, name, intersection_name, location, direction, type,
       ...
       RETURNING id, name, intersection_name,
                 ...
                 is_autonomous, group_id, camera_url, current_state, created_at`, [id, input.name, input.intersectionName, input.longitude, input.latitude, input.direction, input.type,
