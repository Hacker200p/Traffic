...
exports.createAlertSchema = zod_1.z.object({
    type: zod_1.z.enum(['accident', 'congestion', 'signal_malfunction', 'blacklisted_vehicle', 'emergency', 'road_closure', 'weather', 'other']),
...
exports.alertQuerySchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(['accident', 'congestion', 'signal_malfunction', 'blacklisted_vehicle', 'emergency', 'road_closure', 'weather', 'other']).optional(),
    priority: zod_1.z.enum(['low', 'medium', 'high', 'critical']).optional(),
    status: zod_1.z.enum(['active', 'acknowledged', 'resolved', 'expired']).optional(),
